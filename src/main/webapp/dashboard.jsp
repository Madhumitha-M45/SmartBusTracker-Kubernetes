...
<div class="container">
    ...
    <div id="routeStop" class="tabContent">
        ...
        <div class="routeStopActions">
            <button class="btn btnAdd" onclick="saveAllRouteStops()">Save Selected</button>
            <button class="btn btnDelete" onclick="deleteSelectedRouteStops()">Delete Unselected</button>
        </div>
        <div class="tableContainer">
