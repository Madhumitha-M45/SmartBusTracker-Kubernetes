...
public class BusLocation {
    ...
    public String toString() {
        return "BusLocation{" +"busId='" + busId + '\'' +", scheduleId='" + scheduleId + '\'' + ", routeId='" + routeId + '\'' +", status='" + status + '\'' +", currentStopId='" + currentStopId + '\'' +", currentStopName='" + currentStopName + '\'' +", nextStopId='" + nextStopId + '\'' +
                ", nextStopName='" + nextStopName + '\'' +", speed=" + speed +", distanceCovered=" + distanceCovered +", distanceRemaining=" + distanceRemaining +", progress=" + progress +
                ", delayMinutes=" + delayMinutes +", eta='" + eta + '\'' +", lastUpdated='" + lastUpdated + '\'' +'}';
    }
}